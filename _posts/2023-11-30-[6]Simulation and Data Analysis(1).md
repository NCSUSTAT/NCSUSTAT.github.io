...
$C(s, t) = \sigma_{X(s)}\sigma_{X(t)}\rho(s, t)$ with the variance function $\sigma^2_X(t) = 1$ and the Matérn correlation function $\rho_{\theta= (0.5, 1)}$.
